"""Generate the approved Neoclassical Courthouse and its final-review package."""
...
ASSET_ID = "neoclassical-courthouse"
ASSET_NAME = "Neoclassical Courthouse"
FOOTPRINT = (34.0, 23.0)
...
def add_stairs_and_portico(asset, materials) -> None:
    ...
    for x in (-5.1, -1.7, 1.7, 5.1):
        ...
        add_fluted_column(asset, "IonicFlutedShaft", (x, column_y, 6.38), 0.43, 6.55, trim, 20)
...
def add_review_environment(review, materials) -> None:
    ...
    sun_data = bpy.data.lights.new("SouthernSun", "SUN")
    sun_data.energy = 2.8
    sun_data.angle = math.radians(4.0)
    sun = bpy.data.objects.new("SouthernSun", sun_data)
...
The candidate has not been added to the runtime catalogue. Final approval authorizes that integration and unlocks concept work on the Greek Revival Residence.
"""
...
def main() -> None:
    ...
    root = bpy.data.objects.new("NeoclassicalCourthouse", None)
