"""Generate the approved three-variant Southern live oak vegetation package."""
...
from heritage_blender import add_camera, collection, look_at, move_to_collection, reset_scene


ASSET_ID = "southern-live-oak"
ASSET_NAME = "Southern Live Oak"
VARIANTS = ("Courtyard", "Windswept", "LowSpreading")
PROJECT_ROOT = Path(__file__).resolve().parents[2]
FOLIAGE_SOURCE = PROJECT_ROOT / "docs/assets/concepts/southern-live-oak/source/foliage-alpha-v1.png"
BARK_SOURCE = PROJECT_ROOT / "docs/assets/concepts/southern-live-oak/source/bark-source-v1.png"
...
def main() -> None:
    ...
    root = bpy.data.objects.new("SouthernLiveOak", None)
    asset.objects.link(root)
    root["assetId"] = ASSET_ID
    root["approvedConcept"] = "docs/assets/concepts/southern-live-oak/concept-v1.png"
