# Porch Residence — concept v1

Status: **Concept approved — 7 August 2026**

![Porch Residence concept v1](concept-v1.png)

## Design lock proposed by this sheet

- Early nineteenth-century two-storey porch residence with maintained age.
...
- Full-width, full-height colonnade of six painted timber columns supports a continuous plain entablature and the front eave.
...
- The formal central entrance uses paired paneled doors, a rectangular multi-light transom, narrow sidelights, plain pilasters, a heavy lintel, and dark metal hardware.
...
The orthographic views define the main proportions, five-bay organization, six-column rhythm, gallery depth, window spacing, chimney positions, and roof silhouette. The beauty view governs material hierarchy and visual character. Detail panels govern the column rhythm, entrance, layered window depth, shutter hardware, standing-seam roof and drainage assembly, and the foundation-to-porch relationship.
...
- Final prompt: create an original, internally consistent early nineteenth-century porch residence concept sheet with a 24 m × 17 m five-bay timber body, six-column full-height gallery, coherent hipped standing-seam roof and drainage, paired brick chimneys, formal entrance, layered sash-window depth, shutters and hardware, raised detailed foundation, matching beauty and orthographic views, five construction callouts, material swatches, dimensions, and maintained age; exclude identifying names, specific-property imitation, modern elements, interiors, neglect, and structurally unexplained details.
